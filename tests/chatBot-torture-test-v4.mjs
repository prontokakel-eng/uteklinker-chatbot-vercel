...
const TAB_NAME = MODE === "backend" ? "TEST_TORTURE" : "TEST_TORTURE";
...
(async () => {
  ...
  try {
    ...
    const TAB_NAME = MODE === "backend" ? (process.env.SHEET_TAB_NAME_PROD || "TEST_TORTURE") : (process.env.SHEET_TAB_NAME || "TEST_TORTURE");
    const tabIdEnv = MODE === "backend" ? process.env.SHEET_TAB_ID_TEST_TORTURE : process.env.SHEET_TAB_ID_TEST_TORTURE;
